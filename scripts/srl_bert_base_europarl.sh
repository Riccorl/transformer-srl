...
export SRL_TRAIN_DATA_PATH="/mnt/d/Datasets/conll2012/conll_like/europarl/en/data/train"
...
allennlp train "$CONFIG" -s models/bert_base_europarl_en --include-package srl_bert_verbatlas
